...
type PulpSpec struct {
	...
	IngressAnnotations string `json:"ingress_annotations,omitempty"`
	...
	/*
		FIELDS NOT AVAILABLE IN ANSIBLE CRD
	*/
	...
	*/
	...
	// +kubebuilder:validation:Optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:advanced"}
	PostgresTolerations string `json:"postgres_tolerations,omitempty"`

	// [DEPRECATED] Temporarily adding to keep compatibility with ansible version.
	// Topology rule(s) for the pods.
	// +kubebuilder:validation:Optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:advanced"}
	TopologySpreadConstraints string `json:"topology_spread_constraints,omitempty"`
