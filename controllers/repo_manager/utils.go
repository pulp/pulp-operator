...
func getPulpSetting(pulp *repomanagerpulpprojectorgv1beta3.Pulp, key string) string {
...
func addCustomPulpSettings(pulp *repomanagerpulpprojectorgv1beta3.Pulp, current_settings string) string {
	settings := pulp.Spec.PulpSettings.Raw
	var settingsJson map[string]interface{}
	json.Unmarshal(settings, &settingsJson)
...
func (r *RepoManagerReconciler) updateStatus(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, conditionStatus metav1.ConditionStatus, conditionType, conditionReason, conditionMessage string) {
...
func (r *RepoManagerReconciler) updateCRField(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, fieldName, fieldValue string) error {
...
func (r *RepoManagerReconciler) createEmptyConfigMap(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
...
func mountCASpec(pulp *repomanagerpulpprojectorgv1beta3.Pulp, volumes []corev1.Volume, volumeMounts []corev1.VolumeMount) ([]corev1.Volume, []corev1.VolumeMount) {
...
// the change if so
func (r *RepoManagerReconciler) checkImmutableFields(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, field immutableField, log logr.Logger) bool {
	...
	case repomanagerpulpprojectorgv1beta3.PulpSpec:
		fieldSpec = reflect.Indirect(reflect.ValueOf(&pulp.Spec)).FieldByName(field.FieldName)
	case repomanagerpulpprojectorgv1beta3.Cache:
...
func (r *RepoManagerReconciler) updateIngressType(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp) {
...
// modification scenarios
func (r *RepoManagerReconciler) updateIngressClass(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp) {
...
type ResourceDefinition struct {
	...
	*repomanagerpulpprojectorgv1beta3.Pulp
}
...
func isIngress(pulp *repomanagerpulpprojectorgv1beta3.Pulp) bool {
...
func (r *RepoManagerReconciler) isNginxIngress(pulp *repomanagerpulpprojectorgv1beta3.Pulp) bool {
...
func getRouteHost(resource FunctionResources) string {
	...
	if len(resource.Pulp.Spec.RouteHost) == 0 {
		...
		routeHost = resource.Pulp.Name + "-" + resource.Pulp.Namespace + "." + ingress.Spec.Domain
	}
	return routeHost
}
