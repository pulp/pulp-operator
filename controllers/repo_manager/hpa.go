...
// isHPAEnabled checks if HPA is enabled for a specific component
func isHPAEnabled(pulp *pulpv1.Pulp, pulpcoreType settings.PulpcoreType) bool {
	hpaConfig := getHPAConfig(pulp, pulpcoreType)
	return hpaConfig != nil && hpaConfig.Enabled
}
