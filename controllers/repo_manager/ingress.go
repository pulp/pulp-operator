...
func (r *RepoManagerReconciler) pulpIngressController(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
...
// pulp-ingress
func (r *RepoManagerReconciler) pulpIngressObject(ctx context.Context, m *repomanagerpulpprojectorgv1beta3.Pulp, plugins []IngressPlugin) (*netv1.Ingress, error) {
