...
func (r *RepoManagerReconciler) pulpCacheController(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
...
// pulp-redis-data PVC
func redisDataPVC(m *repomanagerpulpprojectorgv1beta3.Pulp) *corev1.PersistentVolumeClaim {
...
// redis-svc Service
func redisSvc(m *repomanagerpulpprojectorgv1beta3.Pulp) *corev1.Service {
...
func redisDeployment(m *repomanagerpulpprojectorgv1beta3.Pulp) *appsv1.Deployment {
...
func (r *RepoManagerReconciler) deprovisionCache(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
	// redis-svc Service
	svcFound := &corev1.Service{}
	err := r.Get(ctx, types.NamespacedName{Name: pulp.Name + "-redis-svc", Namespace: pulp.Namespace}, svcFound)
