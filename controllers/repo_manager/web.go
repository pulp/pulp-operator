...
func (r *RepoManagerReconciler) pulpWebController(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
...
func (r *RepoManagerReconciler) deploymentForPulpWeb(m *repomanagerpulpprojectorgv1beta3.Pulp) *appsv1.Deployment {
...
func labelsForPulpWeb(m *repomanagerpulpprojectorgv1beta3.Pulp) map[string]string {
...
func serviceForPulpWeb(m *repomanagerpulpprojectorgv1beta3.Pulp) *corev1.Service {
...
func (r *RepoManagerReconciler) pulpWebConfigMap(m *repomanagerpulpprojectorgv1beta3.Pulp) *corev1.ConfigMap {
