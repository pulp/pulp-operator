...
func (r *RepoManagerReconciler) pulpApiController(ctx context.Context, pulp *repomanagerpulpprojectorgv1beta3.Pulp, log logr.Logger) (ctrl.Result, error) {
...
func labelsForPulpApi(m *repomanagerpulpprojectorgv1beta3.Pulp) map[string]string {
...
func storageClassProvided(pulp *repomanagerpulpprojectorgv1beta3.Pulp) bool {
