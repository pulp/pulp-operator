...
func (r *RepoManagerRestoreReconciler) restoreDatabaseData(ctx context.Context, pulpRestore *repomanagerpulpprojectorgv1beta3.PulpRestore, backupDir string, pod *corev1.Pod) error {
	log := r.RawLogger
	backupFile := "pulp.db"
