...
func (r *RepoManagerBackupReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	pulpBackup := &repomanagerpulpprojectorgv1beta3.PulpBackup{}
...
func (r *RepoManagerBackupReconciler) createBackupPod(ctx context.Context, pulpBackup *repomanagerpulpprojectorgv1beta3.PulpBackup, backupDir string) (*corev1.Pod, error) {
	log := r.RawLogger
...
func (r *RepoManagerBackupReconciler) cleanup(ctx context.Context, pulpBackup *repomanagerpulpprojectorgv1beta3.PulpBackup) error {
	bkpPod := &corev1.Pod{}
...
func (r *RepoManagerBackupReconciler) createBackupPVC(ctx context.Context, pulpBackup *repomanagerpulpprojectorgv1beta3.PulpBackup) error {
	log := r.RawLogger
...
func (r *RepoManagerBackupReconciler) updateStatus(ctx context.Context, pulpBackup *repomanagerpulpprojectorgv1beta3.PulpBackup, conditionStatus metav1.ConditionStatus, conditionType, conditionMessage, conditionReason string) {
...
func (r *RepoManagerBackupReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&repomanagerpulpprojectorgv1beta3.PulpBackup{}).
