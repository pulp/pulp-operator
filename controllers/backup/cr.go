...
func (r *RepoManagerBackupReconciler) backupCR(ctx context.Context, pulpBackup *repomanagerpulpprojectorgv1beta3.PulpBackup, backupDir string, pod *corev1.Pod) error {
	log := r.RawLogger
